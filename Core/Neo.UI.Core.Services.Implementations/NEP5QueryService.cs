...
{
    internal class NEP5QueryService : INEP5QueryService
    {
        public NEP5AssetItem GetTotalBalance(UInt160 nep5ScriptHash, IEnumerable<UInt160> accountScriptHashes)
        {
            byte[] script;
        ...
        public IDictionary<UInt160, BigDecimal> GetBalances(UInt160 nep5ScriptHash, IEnumerable<UInt160> accountScriptHashes)
        {
